...
object ProductInfoDataClean {

    def main(args: Array[String]): Unit = {
        val tableName: String = "product_info"
        val odsTableName: String = "ods.product_info"
        val dwdTableName: String = "dwd.dim_product_info"
        val mergeCol: String = "product_core"
